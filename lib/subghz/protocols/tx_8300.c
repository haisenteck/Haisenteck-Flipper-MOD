...
struct subghz_protocol_DecoderTX_8300 {
...
struct subghz_protocol_EncoderTX_8300 {
...
void* subghz_protocol_decoder_tx_8300_alloc(SubGhzEnvironment* environment) {
    UNUSED(environment);
    subghz_protocol_DecoderTX_8300* instance = malloc(sizeof(subghz_protocol_DecoderTX_8300));
...
void subghz_protocol_decoder_tx_8300_free(void* context) {
    furi_assert(context);
    subghz_protocol_DecoderTX_8300* instance = context;
    free(instance);
}
...
static bool subghz_protocol_tx_8300_check_crc(subghz_protocol_DecoderTX_8300* instance) {
 ...
 */
static void subghz_protocol_tx_8300_remote_controller(SubGhzBlockGeneric_wheather* instance) {
