...
typedef struct subghz_protocolDecoderOregon_V1 subghz_protocolDecoderOregon_V1;
typedef struct subghz_protocolEncoderOregon_V1 subghz_protocolEncoderOregon_V1;
...
/**
 * Allocate subghz_protocolDecoderOregon_V1.
 * @param environment Pointer to a SubGhzEnvironment instance
 * @return subghz_protocolDecoderOregon_V1* pointer to a subghz_protocolDecoderOregon_V1 instance
 */
void* subghz_protocol_decoder_oregon_v1_alloc(SubGhzEnvironment* environment);

/**
 * Free subghz_protocolDecoderOregon_V1.
 * @param context Pointer to a subghz_protocolDecoderOregon_V1 instance
 */
void subghz_protocol_decoder_oregon_v1_free(void* context);

/**
 * Reset decoder subghz_protocolDecoderOregon_V1.
 * @param context Pointer to a subghz_protocolDecoderOregon_V1 instance
 */
...
/**
 * Serialize data subghz_protocolDecoderOregon_V1.
 * @param context Pointer to a subghz_protocolDecoderOregon_V1 instance
...
/**
 * Deserialize data subghz_protocolDecoderOregon_V1.
 * @param context Pointer to a subghz_protocolDecoderOregon_V1 instance
 * @param flipper_format Pointer to a FlipperFormat instance
 * @return status
 */
