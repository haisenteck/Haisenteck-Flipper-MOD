...
static const SubGhzBlockConst subghz_protocol_schrader_gg4_const = {
    .te_short = 120,
    .te_long = 240,
...
struct SubGhzProtocolDecoderSchraderGG4 {
...
struct SubGhzProtocolEncoderSchraderGG4 {
...
const SubGhzProtocolDecoder subghz_protocol_schrader_gg4_decoder = {
    .alloc = subghz_protocol_decoder_schrader_gg4_alloc,
    .free = subghz_protocol_decoder_schrader_gg4_free,

    .feed = subghz_protocol_decoder_schrader_gg4_feed,
    .reset = subghz_protocol_decoder_schrader_gg4_reset,

    .get_hash_data = subghz_protocol_decoder_schrader_gg4_get_hash_data,
    .serialize = subghz_protocol_decoder_schrader_gg4_serialize,
    .deserialize = subghz_protocol_decoder_schrader_gg4_deserialize,
    .get_string = subghz_protocol_decoder_schrader_gg4_get_string,
};

const SubGhzProtocolEncoder subghz_protocol_schrader_gg4_encoder = {
    .alloc = NULL,
    .free = NULL,
...
const SubGhzProtocol subghz_protocol_schrader_gg4 = {
...
void* subghz_protocol_decoder_schrader_gg4_alloc(SubGhzEnvironment* environment) {
    UNUSED(environment);
    SubGhzProtocolDecoderSchraderGG4* instance = malloc(sizeof(SubGhzProtocolDecoderSchraderGG4));
    instance->base.protocol = &subghz_protocol_schrader_gg4;
...
void subghz_protocol_decoder_schrader_gg4_free(void* context) {
    furi_assert(context);
    SubGhzProtocolDecoderSchraderGG4* instance = context;
    free(instance);
}
...
static bool subghz_protocol_schrader_gg4_check_crc(SubGhzProtocolDecoderSchraderGG4* instance) {
    uint8_t msg[] = {
 ...
 */
static void subghz_protocol_schrader_gg4_analyze(SubGhzBlockGeneric* instance) {
...
static ManchesterEvent level_and_duration_to_event(bool level, uint32_t duration) {
    ...
    if(DURATION_DIFF(duration, subghz_protocol_schrader_gg4_const.te_long) <
       subghz_protocol_schrader_gg4_const.te_delta) {
        is_long = true;
    } else if(
        DURATION_DIFF(duration, subghz_protocol_schrader_gg4_const.te_short) <
        subghz_protocol_schrader_gg4_const.te_delta) {
        is_long = false;
    } else {
...
void subghz_protocol_decoder_schrader_gg4_feed(void* context, bool level, uint32_t duration) {
    ...
    case SchraderGG4DecoderStepReset:
        ...
        if((level) && (DURATION_DIFF(duration, subghz_protocol_schrader_gg4_const.te_long * 2) <
                       subghz_protocol_schrader_gg4_const.te_delta)) {
    ...
    case SchraderGG4DecoderStepDecoderData:
        ...
        if(instance->decoder.decode_count_bit ==
           subghz_protocol_schrader_gg4_const.min_count_bit_for_found) {
            FURI_LOG_D(TAG, "%016llx", instance->decoder.decode_data);
            if(!subghz_protocol_schrader_gg4_check_crc(instance)) {
                FURI_LOG_D(TAG, "CRC mismatch drop");
            } else {
                instance->generic.data = instance->decoder.decode_data;
                instance->generic.data_count_bit = instance->decoder.decode_count_bit;
                subghz_protocol_schrader_gg4_analyze(&instance->generic);
