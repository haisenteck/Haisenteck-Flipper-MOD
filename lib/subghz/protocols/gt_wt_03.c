...
struct subghz_protocol_DecoderGT_WT03 {
...
struct subghz_protocol_EncoderGT_WT03 {
...
void* subghz_protocol_decoder_gt_wt_03_alloc(SubGhzEnvironment* environment) {
    UNUSED(environment);
    subghz_protocol_DecoderGT_WT03* instance = malloc(sizeof(subghz_protocol_DecoderGT_WT03));
...
void subghz_protocol_decoder_gt_wt_03_free(void* context) {
    furi_assert(context);
    subghz_protocol_DecoderGT_WT03* instance = context;
    free(instance);
}
...
static bool subghz_protocol_gt_wt_03_check_crc(subghz_protocol_DecoderGT_WT03* instance) {
    uint8_t msg[] = {
 ...
 */
static void subghz_protocol_gt_wt_03_remote_controller(SubGhzBlockGeneric_wheather* instance) {
