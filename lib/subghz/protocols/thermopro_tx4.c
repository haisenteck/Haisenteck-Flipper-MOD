...
struct subghz_protocol_DecoderThermoPRO_TX4 {
...
void* subghz_protocol_decoder_thermopro_tx4_alloc(SubGhzEnvironment* environment) {
    UNUSED(environment);
    subghz_protocol_DecoderThermoPRO_TX4* instance = malloc(sizeof(subghz_protocol_DecoderThermoPRO_TX4));
...
static bool subghz_protocol_thermopro_tx4_check(subghz_protocol_DecoderThermoPRO_TX4* instance) {
