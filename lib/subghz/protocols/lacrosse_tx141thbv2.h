...
typedef struct subghz_protocol_DecoderLaCrosse_TX141THBv2 subghz_protocol_DecoderLaCrosse_TX141THBv2;
typedef struct subghz_protocol_EncoderLaCrosse_TX141THBv2 subghz_protocol_EncoderLaCrosse_TX141THBv2;
...
/**
 * Allocate subghz_protocol_DecoderLaCrosse_TX141THBv2.
 * @param environment Pointer to a SubGhzEnvironment instance
 * @return subghz_protocol_DecoderLaCrosse_TX141THBv2* pointer to a subghz_protocol_DecoderLaCrosse_TX141THBv2 instance
 */
void* subghz_protocol_decoder_lacrosse_tx141thbv2_alloc(SubGhzEnvironment* environment);

/**
 * Free subghz_protocol_DecoderLaCrosse_TX141THBv2.
 * @param context Pointer to a subghz_protocol_DecoderLaCrosse_TX141THBv2 instance
 */
void subghz_protocol_decoder_lacrosse_tx141thbv2_free(void* context);

/**
 * Reset decoder subghz_protocol_DecoderLaCrosse_TX141THBv2.
 * @param context Pointer to a subghz_protocol_DecoderLaCrosse_TX141THBv2 instance
 */
...
/**
 * Serialize data subghz_protocol_DecoderLaCrosse_TX141THBv2.
 * @param context Pointer to a subghz_protocol_DecoderLaCrosse_TX141THBv2 instance
...
/**
 * Deserialize data subghz_protocol_DecoderLaCrosse_TX141THBv2.
 * @param context Pointer to a subghz_protocol_DecoderLaCrosse_TX141THBv2 instance
 * @param flipper_format Pointer to a FlipperFormat instance
 * @return status
 */
